...
- **Less kept about a manifest transaction, for less time.** A completed
  manifest execution now stores only its txid. Everything else was reconstructible
  from the request being replayed, and keeping it made that table a readable
  record of what you had been doing for seven days.
